    ...
    return (
        <div className="min-h-screen bg-indigo-950 flex flex-col justify-center items-center p-4">
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl shadow-xl w-full max-w-md border border-purple-500/30">
                <h1 className="text-3xl font-bold text-white mb-6 text-center">Report a Contract</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label htmlFor="contractId" className="block text-purple-200 mb-2 text-sm font-medium">
                            Contract Name or ID <span className="text-red-400">*</span>
                        </label>
                        <input
                            id="contractId"
                            type="text"
                            ...
                            placeholder="e.g. Sales Agreement #123"
                            required
                        />
                    </div>
