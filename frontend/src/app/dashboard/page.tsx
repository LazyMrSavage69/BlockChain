                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    ...
                    <div className="bg-white/10 backdrop-blur-md border border-purple-500/20 rounded-2xl p-6 shadow-xl hover:transform hover:scale-105 transition-all">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-purple-300 text-sm font-medium">Paiements Complétés</p>
                                <h3 className="text-3xl font-bold">{stats.paymentsCompleted}</h3>
                                {stats.paymentsPending > 0 && (
                                    <p className="text-xs text-yellow-300 mt-1">{stats.paymentsPending} en attente</p>
                                )}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md border border-purple-500/20 rounded-2xl p-6 shadow-xl hover:transform hover:scale-105 transition-all">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-purple-300 text-sm font-medium">Total Payé (ETH)</p>
                                <h3 className="text-3xl font-bold">{stats.totalPaid.toFixed(4)}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md border border-purple-500/20 rounded-2xl p-6 shadow-xl hover:transform hover:scale-105 transition-all">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-purple-300 text-sm font-medium">Interactions Uniques</p>
